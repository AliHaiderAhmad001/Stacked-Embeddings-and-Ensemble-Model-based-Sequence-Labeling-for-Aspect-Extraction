...
Original file is located at
    https://colab.research.google.com/drive/1ElKPEmhE0AMy8T1WdWnDibcRoqNPsLNx
"""
...
def nn_model(img_path,n_features,optimizer,timesteps):
    img_path=img_path
    ...
    bi_LSTM2_1 = Bidirectional(LSTM(units=512, return_sequences=True,name='Bi_LSTM2_1',activation='tanh',
                                    recurrent_activation = 'tanh',recurrent_dropout=0.0,unroll=False,
                                    use_bias=True))(x)
